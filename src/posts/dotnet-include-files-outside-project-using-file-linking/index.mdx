...
- csharp
resources: [
  ['https://docs.microsoft.com/en-us/visualstudio/msbuild/common-msbuild-project-items?view=vs-2015&redirectedfrom=MSDN#content', 'MS documentation about Content element'],
]
published: true
---
