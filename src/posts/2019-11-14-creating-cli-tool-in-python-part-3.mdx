...
date: 2019-11-14
image: ./images/creating-cli-tool-in-python-part-3.jpg
...
```mermaid
 ...
 title -->|No| End;
 img -->|Yes| downloadImg;
 img -->|No| createTemplate;
 downloadImg --> getImgMetadata;
 getImgMetadata --> createTemplate;
 createTemplate --> End;
```
...
```
<img src="https://i.imgur.com/39Uy4AR.gif" alt="Demonstration of a CLI tool" class="my-1"/>
