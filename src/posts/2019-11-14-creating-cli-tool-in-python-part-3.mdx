...
```
<ImageModal url="https://i.imgur.com/39Uy4AR.gif" text="Demonstration of a CLI tool" />
...
Blog command business l<ImageModal url="https://i.imgur.com/39Uy4AR.gif" text="Demonstration of a CLI tool" />ogic is now moved under a blog_command module.
