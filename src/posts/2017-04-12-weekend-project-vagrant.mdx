...
resources: [
	...
	['http://danilodellaquila.com/en/blog/vagrant-and-virtualbox-installation-on-fedora', 'Vagrant and Virtualbox Installation on Fedora - by D. Dellaquila'],
	['http://stackoverflow.com/questions/22717428/vagrant-error-failed-to-mount-folders-in-linux-guest', 'Stackoverflow answer for mounting problem']
]
published: true
---
...
http://localhost:8080/game/, I see my tetris game.
